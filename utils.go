...
func uint64ToByteArray(number uint64) []byte {
...
// For example, a byte array such as [3 252] will be converted to 1020 instead of [0 0 0 0 0 0 3 252]
...
func uint64ToBase64(id uint64) string {
